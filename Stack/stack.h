...
int checkStackValidity(stack_t *stack, const char *dumpPath = DUMP_PATH, bool abortOnCorruption = ABORT_ON_STACK_CORRUPTION, bool silent = STACK_CORRUPTION_SILENT);
